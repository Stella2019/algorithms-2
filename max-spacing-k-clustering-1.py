...
NUMLIST_FILENAME = "data/msk-clustering.txt" # result: 106
# NUMLIST_FILENAME = "data/tests/msk-clustering-1.1.txt" # result: 2
# NUMLIST_FILENAME = "data/tests/msk-clustering-1.2.txt" # result: 5
